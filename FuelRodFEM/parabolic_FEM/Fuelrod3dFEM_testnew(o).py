...
def from_fuel_rod_gmsh(R1,R2,L,w,h,l,p,meshtype='segmented'):
    ...
    tag2cidx[tetrahedron_tags] = np.arange(NC)
    ...
    gmsh.finalize()
    return TetrahedronMesh(node,cell),cnidx,bdnidx,incidx,cacidx
...
mesh,cnidx,bdnidx,incidx,cacidx = from_fuel_rod_gmsh(R1,R2,L,w,h,l,p,meshtype='segmented')
...
import os
output = './result_fuelrod_bdnidx3d'
filename = 'temp'
